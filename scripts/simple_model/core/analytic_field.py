import numpy as np
def analytic_field(atom_polarizabilities, atoms, frequencies, E_type, N1, N2, atom_pos=None, R=None, tip_xyz=None, tip_width=None):
    """
    ...
    mode_intensities = np.zeros((n_modes, 2))
