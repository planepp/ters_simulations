...
files = [f"rawdata/intensity_{new_mods[0]}.dat" for f in new_freqs]
...
# Use tippos_indices from intensity calculations
...
im = ax.pcolormesh(xedges, yedges, masked, cmap=cmap, zorder=0, vmin=0.0, vmax=None)
